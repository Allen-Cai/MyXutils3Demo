...
public class Child {
    ...
    public com.yhcdhp.cai.db.Parent getParent(DbManager db) throws DbException {
        return db.findById(com.yhcdhp.cai.db.Parent.class, parentId);
    }
